...
[Migration("20260904152100_ProductAvailableFrom")]
partial class _20260904152100_ProductAvailableFrom
{
    /// <inheritdoc />
...
#pragma warning disable 612, 618
        ...
        modelBuilder.Entity("ElGuerre.Tendero.Accounts.Domain.Customer", b =>
            {
                b.Property<Guid>("Id")
                    .HasColumnType("uuid")
                    .HasColumnName("id");
        ...
        modelBuilder.Entity("ElGuerre.Tendero.Ordering.Domain.Order", b =>
            {
                ...
                b.ComplexProperty(typeof(Dictionary<string, object>), "Stop", "ElGuerre.Tendero.Ordering.Domain.Order.Stop#OrderStop", b1 =>
                    {
        ...
        modelBuilder.Entity("ElGuerre.Tendero.SharedKernel.AuditEntry", b =>
            {
                b.Property<Guid>("Id")
                    .HasColumnType("uuid")
                    .HasColumnName("id");
                ...
                b.HasIndex("Agent", "At")
                    ...
                    .HasDatabaseName("ix_audit_entries_agent_at")
                    .HasFilter("agent IS NOT NULL");

                b.HasIndex("Outcome", "At")
                    .IsDescending(false, true)
                    .HasDatabaseName("ix_audit_entries_outcome_at")
